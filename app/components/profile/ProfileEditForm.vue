  ...
  <div class="w-full">
    <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6 md:p-8">
      ...
      <form @submit.prevent="handleSubmit" class="space-y-8">
        ...
        <div class="flex flex-col md:flex-row gap-3 justify-start pt-6 border-t border-gray-100">
         
          <button
            type="submit"
            :disabled="loading"
            class="inline-flex items-center justify-center rounded-xl max-w-md bg-black px-6 py-2.5 text-sm font-semibold text-white hover:bg-gray-900 disabled:opacity-60 disabled:cursor-not-allowed transition-colors"
          >
            <span v-if="!loading">
